...
export default class DataPanel extends GraphPage {
  ...
  private get dataPanelRemoveLabelByLabel(): (label: string) => Locator {
    return (label: string) =>
      this.page.getByTestId(`DataPanelRemoveLabel${label}`);
  }
  ...
  async isVisibleLabel(label: string): Promise<boolean> {
    const isVisible = await waitForElementToBeVisible(
      this.dataPanelLabelByName(label)
    );
    return isVisible;
  }
  ...
  async fillDataPanelAddLabelInput(label: string): Promise<void> {
    await interactWhenVisible(
      this.dataPanelAddLabelInput,
      (el) => el.fill(label),
      "Data Panel Add Label Input"
    );
  }

  async fillDataPanelAddAttributeKey(key: string): Promise<void> {
    await interactWhenVisible(
      this.dataPanelAddAttributeKey,
      (el) => el.fill(key),
      "Data Panel Add Attribute Key"
    );
  }
  ...
  async clickDataPanelRemoveLabelByLabel(label: string): Promise<void> {
    await interactWhenVisible(
      this.dataPanelRemoveLabelByLabel(label),
      (el) => el.click(),
      "Data Panel Remove Label"
    );
  }

  async clickDataPanelAddLabel(): Promise<void> {
    await interactWhenVisible(
      this.dataPanelAddLabel,
      (el) => el.click(),
      "Data Panel Add Label"
    );
  }

  async clickDataPanelAddLabelConfirm(): Promise<void> {
    await interactWhenVisible(
      this.dataPanelAddLabelButton,
      (el) => el.click(),
      "Data Panel Add Label Confirm"
    );
  }

  async clickDataPanelRemoveLabelConfirm(): Promise<void> {
    await interactWhenVisible(
      this.dataPanelRemoveLabelButtonConfirm,
      (el) => el.click(),
      "Data Panel Add Label Confirm"
    );
  }
  ...
  async clickDataPanelAddLabelCancel(): Promise<void> {
    await interactWhenVisible(
      this.dataPanelAddLabelCancel,
      (el) => el.click(),
      "Data Panel Add Label Cancel"
    );
  }

  async clickDataPanelAddAttribute(): Promise<void> {
    await interactWhenVisible(
      this.dataPanelAddAttribute,
      (el) => el.click(),
      "Data Panel Add Attribute"
    );
  }
  ...
  async clickDataPanelAddAttributeConfirm(): Promise<void> {
    await interactWhenVisible(
      ...
      (el) => el.click(),
      "Data Panel Add Attribute Confirm"
    );
  }

  async clickDataPanelAddAttributeCancel(): Promise<void> {
    await interactWhenVisible(
      this.dataPanelAddAttributeCancel,
      (el) => el.click(),
      "Data Panel Add Attribute Cancel"
    );
  }

  async clickDataPanelValueSetAttribute(): Promise<void> {
    await interactWhenVisible(
      this.dataPanelValueSetAttribute,
      (el) => el.click(),
      "Data Panel Value Set Attribute"
    );
  }
  ...
  async clickDataPanelSetAttributeConfirm(): Promise<void> {
    await interactWhenVisible(
      ...
      (el) => el.click(),
      "Data Panel Set Attribute Confirm"
    );
  }

  async clickDataPanelSetAttributeCancel(): Promise<void> {
    await interactWhenVisible(
      this.dataPanelSetAttributeCancel,
      (el) => el.click(),
      "Data Panel Set Attribute Cancel"
    );
  }
  ...
  async clickDataPanelDeleteAttribute(): Promise<void> {
    await interactWhenVisible(
      ...
      (el) => el.click(),
      "Data Panel Delete Attribute"
    );
  }

  async clickDataPanelDeleteAttributeConfirm(): Promise<void> {
    await interactWhenVisible(
      this.dataPanelDeleteAttributeConfirm,
      (el) => el.click(),
      "Data Panel Delete Attribute Confirm"
    );
  }

  async clickDataPanelDeleteAttributeCancel(): Promise<void> {
    await interactWhenVisible(
      this.dataPanelDeleteAttributeCancel,
      (el) => el.click(),
