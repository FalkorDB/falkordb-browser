...
/**
 * Smoke system tests that run against the dockerized stack (the FalkorDB
 * Browser image plus a FalkorDB "core" image). They are intentionally minimal
 * and only assert that the two containers are alive and able to talk to each
 * other through the UI happy-path:
