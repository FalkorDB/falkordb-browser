                    ...
                    <Button
                        ...
                        onClick={() => {
                            ...
                            if (connectionType === "Sentinel") {
                                ...
                                if ((connectionInfo.sentinelRole === "slave" || connectionInfo.sentinelRole === "replica") && connectionInfo.sentinelMasterHost) text += `\nRole: Replica (master: ${connectionInfo.sentinelMasterHost}:${connectionInfo.sentinelMasterPort})`;
                            }
                                ...
                                <div className="flex flex-col gap-1.5 text-sm">
                                    ...
                                    {connectionType === "Sentinel" && (
                                        <>
                                            ...
                                            {(connectionInfo.sentinelRole === "slave" || connectionInfo.sentinelRole === "replica") && connectionInfo.sentinelMasterHost && (
